...
public interface DrawModel {
	 ...
	 * events from this draw model. This method performs no function, nor does it
	...
	/**
	 * ADDED BY SKEEKS to maintain figure order when creating a group
	 */
	int getFigureIndex(Figure f) throws IllegalArgumentException;
}
